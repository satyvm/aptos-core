...
import { FAUCET_URL, NODE_URL, longTestTimeout } from "../unit/test_helper.test";
...
const faucetClient = new FaucetClient(provider.aptosClient.nodeUrl, 'http://127.0.0.1:8081');
