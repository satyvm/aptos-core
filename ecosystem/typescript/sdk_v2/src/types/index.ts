...
export type TransactionData = {
  secondary_signer_addresses?: Array<HexInput>;
  fee_payer_address?: HexInput;
} & (EntryFunctionData | ScriptData | EntryFunctionBCSData);
...
export type AptosRawTransaction = {
...
export type ScriptData = {
  code: string;
  type_arguments: Array<any>; // should be TypeTag
  arguments: Array<Uint8Array>;
};

export type EntryFunctionBCSData = {
  function: MoveStructType;
  type_arguments: Array<any>; // should be TypeTag
  arguments: Array<Uint8Array>;
};
